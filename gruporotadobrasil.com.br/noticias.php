...
<!-- Bandeiras -->
					...
					<tr>
						<td>
							<div id="dvlogin" style=" text-align: center; display: none;">
								Usuário: <input type="text" style="width: 60px; border-color: green; border-style: solid; border-width:1px;" />&nbsp; Senha: <input type="password" style="width: 60px; border-color: green; border-style: solid; border-width:1px;" /> <input value="OK" type="submit" style="border-color: green; border-style: solid; border-width:1px;" />&nbsp;&nbsp;&nbsp;&nbsp;
							</div>					
						</td>
			...
			<tr>
				<td align="right">
					...
					<tr>
						<td><div id="mn1" onmouseover="document.getElementById('mn1').style.backgroundImage='url(img/bgmenu.png)'" onmouseout="document.getElementById('mn1').style.backgroundImage='url()'" style="vertical-align: middle; height: 25px;">Histórico</div></td>
						...
						<td style="width: 20px;">&nbsp;</td>
						<td><div id="mn4" onmouseover="document.getElementById('mn4').style.backgroundImage='url(img/bgmenu.png)'" onmouseout="document.getElementById('mn4').style.backgroundImage='url()'" style="vertical-align: middle; height: 25px;">Certificações</div></td>
					</tr>
					</table>
					-->
	...
	if ($idpost == "") {
		$result = mysql_query("SELECT * FROM jos_content WHERE state = 1 AND catid = 1 ORDER BY created DESC");
		...
		<td>
			...
			<div id="wrap">
			  ...
			  <ul id="mycarousel" class="jcarousel-skin-tango">
				<li><a target="_blank11" href="http://www.rotaconstrutora.com.br/"><img src="http://gruporota.webca.com.br/img/logos_212_color/logo_construtora.png" width="212" alt="" border="0" /></a></li>
				<li><a target="_blank12" href="http://www.fundacaorotadobrasil.org/"><img src="http://gruporota.webca.com.br/img/logos_212_color/logo_engenharia.png" width="212" alt="" border="0" /></a></li>
				<li><a target="_blank13" href="http://www.rotacontabil.com.br/"><img src="http://gruporota.webca.com.br/img/logos_212_color/logo_contabil.png" width="212" alt="" border="0" /></a></li>
				<li><a target="_blank14" href="http://www.fundacaorotadobrasil.org/"><img src="http://gruporota.webca.com.br/img/logos_212_color/logo_fundacao.png" width="212" alt="" border="0" /></a></li>
				<li><a target="_blank15" href="http://www.fundacaorotadobrasil.org/"><img src="http://gruporota.webca.com.br/img/logos_212_color/logo_logistica.png" width="212" alt="" border="0" /></a></li>
			  </ul>
	...
	<div style="width: 100%; height: 40px;  background-repeat: repeat-x; "> <!-- background-color: #014C29; background-image: url('img/degradetopo2.png'); -->
		...
		<div style="width: 960px; width: 100%; height: 15px;  text-align: center; color: #232325; font-size: 10px; line-height: 14px; padding: 13px 0;">
			<center>
				...
				<tr>
					<td align="left" style="vertical-align: middle; color: #232325">2013 Copyright &copy; <b>Grupo Rota do Brasil</b></a><br /></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td align="left">
					...
					<table>
					<tr>
						<td>Siga o Grupo Rota do Brasil | </td>
