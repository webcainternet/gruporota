<?php
	...
	ini_set("sendmail_from","adm@fundacaorotadobrasil.org");
	...
	$to = 'adm@fundacaorotadobrasil.org';
	$subject = 'Contato através do site - Fundacao Rota';

	// message
	$message = "
	<html>
	<body bgcolor='#F8F8F8'>
	  <p>Contato atraves do site - Fundacao Rota</p>
	  <table>
		<tr>
