 ...
 <table style="width: 960px;">
	...
	<tr>
		<td>
			...
			<iframe style="width: 963px; height: 93px; no-scrolling" src="http://fundacaorota.webca.com.br/templates/theme498/jcrl.html" noresize frameborder="0"  scrolling="no"></iframe>
		...
		<div style="width: 960px; width: 100%; height: 15px;  text-align: center; color: #232325; font-size: 10px; line-height: 14px; padding: 13px 0;">
			<center>
				...
				<tr>
					...
					<tr>
						<td style="vertical-align: middle; font-size: 10px; color: #151515;">Siga a Funda&ccedil;&atilde;o Rota do Brasil | </td>
