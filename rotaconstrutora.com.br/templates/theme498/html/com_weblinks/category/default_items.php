...
<tr>
	<td width="11" style="text-align:right;" class="sub-title-wrapper sectiontableheader<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
		<?php echo JText::_('Num'); ?>
	</td>
	<td width="90%" height="20" class="sub-title-wrapper sectiontableheader<?php echo $this->escape($this->params->get( 'pageclass_sfx' )); ?>" style="padding-left:10px;">
		<?php echo JHTML::_('grid.sort',  'Web Link', 'title', $this->lists['order_Dir'], $this->lists['order'] ); ?>
	</td>
	<?php if ( $this->params->get( 'show_link_hits' ) ) : ?>

	<td width="30" height="20" class="sub-title-wrapper sectiontableheader<?php echo $this->escape($this->params->get( 'pageclass_sfx' )); ?>" style="text-align:center;" nowrap="nowrap">
...
<tr class="sectiontableentry<?php echo $item->odd + 1; ?>">
	<td align="right" class="sub-indent-table">
