 ...
 <table style="width: 960px;">
	...
	<tr>
		<td>
			...
			<iframe style="width: 963px; height: 93px; no-scrolling" src="http://rotaconstrutora.webca.com.br/templates/theme498/jcrl.html" noresize frameborder="0"  scrolling="no"></iframe>
	...
	<div style="width: 100%; height: 40px;  background-repeat: repeat-x; "> <!-- background-color: #014C29; background-image: url('img/degradetopo2.png'); -->
		...
		<div style="width: 960px; width: 100%; height: 15px;  text-align: center; color: #232325; font-size: 10px; line-height: 14px; padding: 13px 0;">
			<center>
				...
				<tr>
					<td align="left" style="vertical-align: middle; color: #232325;font-family: arial;font-size: 10px;line-height: 14px;width: 310px;">2013 Copyright &copy; - <a href="#" style="color: #232325;">Grupo Rota do Brasil</a><br /><br /></td>
					<td align="left">
					...
					<tr>
						<td style="vertical-align: middle; font-size: 10px; color: #151515;">Siga a Rota Construtora | </td>
...
$.src='//cdn.zopim.com/?x8mzEL7N9lmScM4tXaTvoNpxjj3R6BUr';z.t=+new Date;$.
