...
class GAnalyticsControllerConfig extends GAnalyticsController
{
	...
	function remove()
	{
		...
		if(!$model->delete()) {
			$msg = JText::_( 'CONFIG_VIEW_CONTROLLER_DELETE_ERROR' );
		} else {
			$msg = JText::_( 'CONFIG_VIEW_CONTROLLER_DELETE_SUCCESS' );
		}
