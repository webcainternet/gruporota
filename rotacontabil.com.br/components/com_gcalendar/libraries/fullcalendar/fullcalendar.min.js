...
"-state-default "+(!l?"fc-leftmost ":"")+(+h==+p?na+"-state-highlight fc-today":"fc-not-today")+"'><div class='fc-day-content'><div>&nbsp;</div></div></td>";C(h,Y);La&&da(h,Y)}F+="</tr></table></div>";ja=o(F).appendTo(a)}}function n(){var d=xb(),i=q(d);i.setHours(b.firstHour);var h=O(d,i)+1;d=function(){aa.scrollTop(h)};d();setTimeout(d,0)}function k(d,i){E=d;$a={};aa.height(d-A.height());s=aa.find("tr:first div").height()+1;ja.css({top:A.find("tr").height(),height:d});i&&n()}function y(d){I=d;Qa.clear();
aa.width(d);$.width("");d=A.find("tr:first th");var i=ja.find("td"),h=aa[0].clientWidth;$.width(h);j=0;Ja(A.find("tr:lt(2) th:first").add(aa.find("tr:first th")).width("").each(function(){j=Math.max(j,o(this).outerWidth())}),j);r=Math.floor((h-j)/m);Ja(i.slice(0,-1),r);Ja(d.slice(1,-2),r);Ja(d.slice(-2,-1),h-j-r*(m-1));ja.css({left:j,width:h-j})}function w(d){d.click(H).mousedown(Fb)}function t(d){d.click(H).mousedown(ra)}function H(d){if(!v.option("selectable")){var i=Math.min(m-1,Math.floor((d.pageX-
ja.offset().left)/r));i=C(q(v.visStart),i*Y+ta);var h=this.className.match(/fc-slot(\d+)/);if(h){h=parseInt(h[1])*b.slotMinutes;var p=Math.floor(h/60);i.setHours(p);i.setMinutes(h%60+Da);v.trigger("dayClick",this,i,false,d)}else v.trigger("dayClick",this,i,true,d)}}function M(d,i){v.reportEvents(J=d);var h,p=d.length,l=[],u=[];for(h=0;h<p;h++)d[h].allDay?l.push(d[h]):u.push(d[h]);Q(fa(l),i);ha(D(u),i)}function sa(d){G();M(J,d)}function G(){v._clearEvents();W.empty();Ba.empty()}function fa(d){d=Ya(v.sliceSegs(d,
...
Qa.left(wa(h))},function(h){return j+Qa.right(wa(h))},W,pa,i);k(E)}}function ha(d,i){var h,p=d.length,l,u,z,F,T,S,V,ea,ka,xa,ab="",Ma={},yb={};for(h=0;h<p;h++){l=d[h];u=l.event;z="fc-event fc-event-vert ";if(l.isStart)z+="fc-corner-top ";if(l.isEnd)z+="fc-corner-bottom ";F=O(l.start,l.start);T=O(l.start,l.end);S=l.col;V=l.level;ea=l.forward||0;ka=j+Qa.left(S*Y+ta);xa=j+Qa.right(S*Y+ta)-ka;xa=Math.min(xa-6,xa*0.95);S=V?xa/(V+ea+1):ea?(xa/(ea+1)-6)*2:xa;V=ka+xa/(V+ea+1)*V*Y+(Ta?xa-S:0);l.top=F;l.left=
...
ka){i.draggable("option","revert",!S||!ea&&!ka);x();if(S){u=ka*Y;if(S.row){if(h&&l){Sa(i.width(r-10),s*Math.round((d.end?(d.end-d.start)/Hb:b.defaultEventMinutes)/b.slotMinutes));i.draggable("option","grid",[r,1]);l=false}}else{N(C(q(d.start),u),C(Pa(d),u));z()}}},F,"drag")},stop:function(F,T){var S=Ea.stop();x();v.trigger("eventDragStop",i,d,F,T);if(S&&(!l||u)){i.find("a").removeAttr("href");S=0;l||(S=Math.round((i.offset().top-Z.offset().top)/s)*b.slotMinutes+Da-(d.start.getHours()*60+d.start.getMinutes()));
...
p=i.position();z=F=0;Ea.start(function(ka,xa,ab,Ma){i.draggable("option","revert",!ka);x();if(ka){u=Ma*Y;if(b.allDaySlot&&!ka.row){if(!l){l=true;h.hide();i.draggable("option","grid",null)}N(C(q(d.start),u),C(Pa(d),u))}else S()}},V,"drag")},drag:function(V,ea){z=Math.round((ea.position.top-p.top)/s)*b.slotMinutes;if(z!=F){l||T(z);F=z}},stop:function(V,ea){var ka=Ea.stop();x();v.trigger("eventDragStop",i,d,V,ea);if(ka&&(u||z||l))v.eventDrop(this,d,u,l?0:z,l,V,ea);else{S();i.css(p);T(0);o.browser.msie&&
i.css("filter","").find("span.fc-event-bg").css("display","");v.showEvents(d,i)}}});function T(V){var ea=ba(q(d.start),V),ka;if(d.end)ka=ba(q(d.end),V);h.text(Ha(ea,ka,v.option("timeFormat")))}function S(){if(l){h.css("display","");i.draggable("option","grid",[r,s]);l=false}}}}function ua(d,i,h){if(!b.disableResizing&&i.resizable){var p,l;i.resizable({handles:{s:"div.ui-resizable-s"},grid:s,start:function(u,z){p=l=0;v.hideEvents(d,i);o.browser.msie&&o.browser.version=="6.0"&&i.css("overflow","hidden");
...
i=i.getHours()*60+i.getMinutes()-Da;var h=Math.floor(i/d),p=$a[h];if(p===K)p=$a[h]=aa.find("tr:eq("+h+") td div")[0].offsetTop;return Math.max(0,Math.round(p-1+s*(i%d/d)))}function ra(d){if(v.option("selectable")){R(d);var i=this,h;Ea.start(function(p,l){Fa();if(p&&p.col==l.col&&!ia(p)){l=P(l);p=P(p);h=[l,ba(q(l),b.slotMinutes),p,ba(q(p),b.slotMinutes)].sort(zb);va(h[0],h[3])}else h=null},d);o(document).one("mouseup",function(p){Ea.stop();if(h){+h[0]==+h[1]&&v.trigger("dayClick",i,h[0],false,p);la(h[0],
h[3],false,p)}})}}function la(d,i,h,p){cb=true;v.trigger("select",v,d,i,h,p)}function R(d){if(cb){Fa();cb=false;v.trigger("unselect",v,d)}}function va(d,i){var h=v.option("selectHelper");if(h){var p=Ca(d,v.visStart)*Y+ta;if(p>=0&&p<m){p=Ra.rect(0,p,0,p,Z);var l=O(d,d),u=O(d,i);if(u>l){p.top=l;p.height=u-l;p.left+=2;p.width-=5;if(o.isFunction(h)){if(d=h(d,i)){p.position="absolute";p.zIndex=8;qa=o(d).css(p).appendTo(Z)}}else{qa=o(ma({title:"",start:d,end:i,className:[],editable:false},p,"fc-event fc-event-vert fc-corner-top fc-corner-bottom "));
...
p=C(q(h),1),l=0;l<m;l++){var u=new Date(Math.max(h,d)),z=new Date(Math.min(p,i));if(u<z){var F=l*Y+ta;F=Ra.rect(0,F,0,F,Z);u=O(h,u);z=O(h,z);F.top=u;F.height=z-u;t(v.renderOverlay(F,Z))}C(h,1);C(p,1)}}function x(){v.clearOverlays()}function U(d){return d.end?q(d.end):ba(q(d.start),b.defaultEventMinutes)}function wa(d){return(d-Math.max(vb,La)+m)%m*Y+ta}function P(d){var i=C(q(v.visStart),d.col*Y+ta);d=d.row;b.allDaySlot&&d--;d>=0&&ba(i,Da+d*b.slotMinutes);return i}function ia(d){return b.allDaySlot&&
!d.row}var A,aa,Z,$,ja,m,e=0,j,r,s,I,E,B,J=[],W,Ba,na,vb,La,Ta,Y,ta,Da,Ua,Qa=new kb(function(d){return ja.find("td:eq("+d+") div div")}),$a={},v=o.extend(this,lb,f,{renderAgenda:g,renderEvents:M,rerenderEvents:sa,clearEvents:G,setHeight:k,setWidth:y,beforeHide:function(){B=aa.scrollTop()},afterShow:function(){aa.scrollTop(B)},defaultEventEnd:function(d){var i=q(d.start);if(d.allDay)return i;return ba(i,b.defaultEventMinutes)}});v.name=c;v.init(a,b);mb(a.addClass("fc-agenda"));var Ra=new nb(function(d,
i){function h(V){return Math.max(F,Math.min(T,V))}var p,l,u;ja.find("td").each(function(V,ea){p=o(ea);l=p.offset().left;if(V)u[1]=l;u=[l];i[V]=u});u[1]=l+p.outerWidth();if(b.allDaySlot){p=A.find("td");l=p.offset().top;d[0]=[l,l+p.outerHeight()]}for(var z=Z.offset().top,F=aa.offset().top,T=F+aa.outerHeight(),S=0;S<e;S++)d.push([h(z+s*S),h(z+s*(S+1))])}),Ea=new ob(Ra),cb=false,Fb=pb(v,Ea,P,ia,N,x,la,R);v.select=function(d,i,h){Ra.build();R();if(h){if(b.allDaySlot){i||(i=q(d));N(d,C(q(i),1))}}else{i||
(i=ba(q(d),b.slotMinutes));va(d,i)}la(d,i,h)};v.unselect=R;qb(v,R);var qa;v.dragStart=function(d,i){Ea.start(function(h){x();if(h)if(ia(h))L(h.row,h.col,h.row,h.col);else{h=P(h);var p=ba(q(h),b.defaultEventMinutes);Aa(h,p)}},i)};v.dragStop=function(d,i,h){var p=Ea.stop();x();p&&v.trigger("drop",d,P(p),ia(p),i,h)}}function Gb(a){var b,f,c,g,n,k;for(b=a.length-1;b>0;b--){g=a[b];for(f=0;f<g.length;f++){n=g[f];for(c=0;c<a[b-1].length;c++){k=a[b-1][c];if(Ab(n,k))k.forward=Math.max(k.forward||0,(n.forward||
...
$.find("div.fc-button-"+e).addClass(g+"-state-active")}Aa=e;k();R.css("overflow","");j&&gb(R,1);!r&&x.afterShow&&x.afterShow();N--}}function k(e){if(y()){N++;t();va===K&&ga();if(!x.start||e||L<x.start||L>=x.end){x.render(L,e||0);X(true);!ia||!a.lazyFetching||x.visStart<ia||x.visEnd>A?Q():x.renderEvents(P)}else if(x.sizeDirty||x.eventsDirty||!a.lazyFetching){x.clearEvents();x.sizeDirty&&X();a.lazyFetching?x.renderEvents(P):Q()}la=ra.outerWidth();x.sizeDirty=false;x.eventsDirty=false;if($){$.find("h2.fc-header-title").html(x.title);
...
false}}function G(){o.each(U,function(){this.sizeDirty=true})}function fa(e){P=[];ia=q(x.visStart);A=q(x.visEnd);for(var j=c.length,r=function(){--j||e&&e(P)},s=0;s<c.length;s++)D(c[s],r)}function D(e,j){var r=x.name,s=q(L),I=function(J){if(r==x.name&&+s==+L&&o.inArray(e,c)!=-1){for(var W=0;W<J.length;W++){Ia(J[W],a);J[W].source=e}P=P.concat(J);j&&j(J)}},E=function(J){I(J);ma()};if(typeof e=="string"){var B={};B[a.startParam]=Math.round(ia.getTime()/1E3);B[a.endParam]=Math.round(A.getTime()/1E3);
B.browserTimezone=ia.getTimezoneOffset();if(a.cacheParam)B[a.cacheParam]=(new Date).getTime();ha();o.ajax({url:e,dataType:"json",data:B,cache:a.cacheParam||false,success:E})}else if(o.isFunction(e)){ha();e(q(ia),q(A),E)}else e?I(e):alert("Error detected in fullcalender fetchEventSource()\nPlease check the last comma at the end of your feed list.")}function Q(){fa(function(e){x.renderEvents(e)})}function ha(){aa++||x.trigger("loading",O,true)}function ma(){--aa||x.trigger("loading",O,false)}function pa(e){if(e){var j=
o("<tr/>");o.each(e.split(" "),function(r){r>0&&j.append("<td><span class='fc-header-space'/></td>");var s;o.each(this.split(","),function(I,E){if(E=="title"){j.append("<td><h2 class='fc-header-title'>&nbsp;</h2></td>");s&&s.addClass(g+"-corner-right");s=null}else{var B;if(Z[E])B=Z[E];else if(Oa[E])B=function(){J.removeClass(g+"-state-hover");n(E)};if(B){s&&s.addClass(g+"-no-right");var J;I=a.theme?hb(a.buttonIcons,E):null;var W=hb(a.buttonText,E);if(I)J=o("<div class='fc-button-"+E+" ui-state-default'><a><span class='ui-icon ui-icon-"+
I+"'/></a></div>");else if(W)J=o("<div class='fc-button-"+E+" "+g+"-state-default'><a><span>"+W+"</span></a></div>");if(J){J.click(function(){J.hasClass(g+"-state-disabled")||B()}).mousedown(function(){J.not("."+g+"-state-active").not("."+g+"-state-disabled").addClass(g+"-state-down")}).mouseup(function(){J.removeClass(g+"-state-down")}).hover(function(){J.not("."+g+"-state-active").not("."+g+"-state-disabled").addClass(g+"-state-hover")},function(){J.removeClass(g+"-state-hover").removeClass(g+"-state-down")}).appendTo(o("<td/>").appendTo(j));
s?s.addClass(g+"-no-right"):J.addClass(g+"-corner-left");s=J}}}});s&&s.addClass(g+"-corner-right")});return o("<table/>").append(j)}}function ga(){va=a.contentHeight?a.contentHeight:a.height?a.height-($?$.height():0)-bb(R[0]):Math.round(R.width()/Math.max(a.aspectRatio,0.5))}function X(e){N++;x.setHeight(va,e);if(wa){wa.css("position","relative");wa=null}x.setWidth(R.width(),e);N--}function ca(){if(!N)if(x.start){var e=++Fa;setTimeout(function(){if(e==Fa&&!N&&y())if(la!=(la=ra.outerWidth())){N++;
sa();x.trigger("windowResize",O);N--}},200)}else ua()}function ua(){setTimeout(function(){!x.start&&w()&&k()},0)}var O=this,ra=o(O).addClass("fc"),la,R=o("<div class='fc-content "+g+"-widget-content' style='position:relative'/>").prependTo(O),va,Fa=0,N=0,L=new Date,Aa,x,U={},wa;a.isRTL&&ra.addClass("fc-rtl");a.theme&&ra.addClass("ui-widget");Cb(L,a.year,a.month,a.date);var P=[],ia,A,aa=0,Z={render:function(){ga();G();M();k()},changeView:n,getView:function(){return x},getDate:function(){return L},
option:function(e,j){if(j===K)return a[e];if(e=="height"||e=="contentHeight"||e=="aspectRatio"){a[e]=j;sa()}},destroy:function(){o(window).unbind("resize",ca);$&&$.remove();R.remove();o.removeData(O,"fullCalendar")},prev:function(){k(-1)},next:function(){k(1)},prevYear:function(){db(L,-1);k()},nextYear:function(){db(L,1);k()},today:function(){L=new Date;k()},gotoDate:function(e,j,r){if(typeof e=="object")L=q(e);else Cb(L,e,j,r);k()},incrementDate:function(e,j,r){e!==K&&db(L,e);j!==K&&eb(L,j);r!==
K&&C(L,r);k()},updateEvent:function(e){var j,r=P.length,s,I=e.start-e._start,E=e.end?e.end-(e._end||x.defaultEventEnd(e)):0;for(j=0;j<r;j++){s=P[j];if(s._id==e._id&&s!=e){s.start=new Date(+s.start+I);s.end=e.end?s.end?new Date(+s.end+E):new Date(+x.defaultEventEnd(s)+E):null;s.title=e.title;s.url=e.url;s.allDay=e.allDay;s.className=e.className;s.editable=e.editable;Ia(s,a)}}Ia(e,a);H()},renderEvent:function(e,j){Ia(e,a);if(!e.source){if(j)(e.source=c[0]).push(e);P.push(e)}H()},removeEvents:function(e){if(e){if(!o.isFunction(e)){var j=
e+"";e=function(s){return s._id==j}}P=o.grep(P,e,true);for(r=0;r<c.length;r++)if(typeof c[r]=="object")c[r]=o.grep(c[r],e,true)}else{P=[];for(var r=0;r<c.length;r++)if(typeof c[r]=="object")c[r]=[]}H()},clientEvents:function(e){if(o.isFunction(e))return o.grep(P,e);else if(e){e+="";return o.grep(P,function(j){return j._id==e})}return P},rerenderEvents:H,addEventSource:function(e){c.push(e);D(e,H)},removeEventSource:function(e){c=o.grep(c,function(j){return e&&j!=e});P=o.grep(P,function(j){return e&&
j.source!=e});H()},refetchEvents:function(){fa(H)},select:function(e,j,r){x.select(e,j,r===K?true:r)},unselect:function(){x.unselect()}};o.data(this,"fullCalendar",Z);var $,ja=a.header;if(ja)$=o("<table class='fc-header'/>").append(o("<tr/>").append(o("<td class='fc-header-left'/>").append(pa(ja.left))).append(o("<td class='fc-header-center'/>").append(pa(ja.center))).append(o("<td class='fc-header-right'/>").append(pa(ja.right)))).prependTo(ra);o(window).resize(ca);if(a.droppable){var m;o(document).bind("dragstart",
function(e,j){var r=e.target,s=o(r);if(!s.parents(".fc").length){var I=a.dropAccept;if(o.isFunction(I)?I.call(r,s):s.is(I)){m=r;x.dragStart(m,e,j)}}}).bind("dragstop",function(e,j){if(m){x.dragStop(m,e,j);m=null}})}n(a.defaultView);w()||ua()});return this};var Eb=0;Db({weekMode:"fixed"});Oa.month=function(a,b,f){return new Wa(a,b,{render:function(c,g){if(g){eb(c,g);c.setDate(1)}c=this.start=q(c,true);c.setDate(1);this.end=eb(q(c),1);var n=this.visStart=q(c);g=this.visEnd=q(this.end);var k=b.weekends?
0:1;if(k){da(n);da(g,-1,true)}C(n,-((n.getDay()-Math.max(b.firstDay,k)+7)%7));C(g,(7-g.getDay()+Math.max(b.firstDay,k))%7);n=Math.round((g-n)/(Bb*7));if(b.weekMode=="fixed"){C(g,(6-n)*7);n=6}this.title=oa(c,this.option("titleFormat"),b);this.renderGrid(n,b.weekends?7:5,this.option("columnFormat"),true)}},f)};Oa.basicWeek=function(a,b,f){return new Wa(a,b,{render:function(c,g){g&&C(c,g*7);c=this.visStart=q(this.start=C(q(c),-((c.getDay()-b.firstDay+7)%7)));g=this.visEnd=q(this.end=C(q(c),7));if(!b.weekends){da(c);
da(g,-1,true)}this.title=Ha(c,C(q(g),-1),this.option("titleFormat"),b);this.renderGrid(1,b.weekends?7:5,this.option("columnFormat"),false)}},f)};Oa.basicDay=function(a,b,f){return new Wa(a,b,{render:function(c,g){if(g){C(c,g);b.weekends||da(c,g<0?-1:1)}this.title=oa(c,this.option("titleFormat"),b);this.start=this.visStart=q(c,true);this.end=this.visEnd=C(q(this.start),1);this.renderGrid(1,1,this.option("columnFormat"),false)}},f)};var Xa;Db({allDaySlot:true,allDayText:"all-day",firstHour:6,slotMinutes:30,
defaultEventMinutes:120,axisFormat:"h(:mm)tt",timeFormat:{agenda:"h:mm{ - h:mm}"},dragOpacity:{agenda:0.5},minTime:0,maxTime:24});Oa.agendaWeek=function(a,b,f){return new ub(a,b,{render:function(c,g){g&&C(c,g*7);c=this.visStart=q(this.start=C(q(c),-((c.getDay()-b.firstDay+7)%7)));g=this.visEnd=q(this.end=C(q(c),7));if(!b.weekends){da(c);da(g,-1,true)}this.title=Ha(c,C(q(g),-1),this.option("titleFormat"),b);this.renderAgenda(b.weekends?7:5,this.option("columnFormat"))}},f)};Oa.agendaDay=function(a,
b,f){return new ub(a,b,{render:function(c,g){if(g){C(c,g);b.weekends||da(c,g<0?-1:1)}this.title=oa(c,this.option("titleFormat"),b);this.start=this.visStart=q(c,true);this.end=this.visEnd=C(q(this.start),1);this.renderAgenda(1,this.option("columnFormat"))}},f)};var lb={init:function(a,b){this.element=a;this.options=b;this.eventsByID={};this.eventElements=[];this.eventElementsByID={};this.usedOverlays=[];this.unusedOverlays=[]},trigger:function(a,b){if(this.options[a])return this.options[a].apply(b||
this,Array.prototype.slice.call(arguments,2).concat([this]))},eventEnd:function(a){return a.end?q(a.end):this.defaultEventEnd(a)},reportEvents:function(a){var b,f=a.length,c,g=this.eventsByID={};for(b=0;b<f;b++){c=a[b];if(g[c._id])g[c._id].push(c);else g[c._id]=[c]}},reportEventElement:function(a,b){this.eventElements.push(b);var f=this.eventElementsByID;if(f[a._id])f[a._id].push(b);else f[a._id]=[b]},_clearEvents:function(){this.eventElements=[];this.eventElementsByID={}},showEvents:function(a,b){this._eee(a,
b,"show")},hideEvents:function(a,b){this._eee(a,b,"hide")},_eee:function(a,b,f){a=this.eventElementsByID[a._id];var c,g=a.length;for(c=0;c<g;c++)a[c][0]!=b[0]&&a[c][f]()},eventDrop:function(a,b,f,c,g,n,k){var y=this,w=b.allDay,t=b._id;y.moveEvents(y.eventsByID[t],f,c,g);y.trigger("eventDrop",a,b,f,c,g,function(){y.moveEvents(y.eventsByID[t],-f,-c,w);y.rerenderEvents()},n,k);y.eventsChanged=true;y.rerenderEvents(t)},eventResize:function(a,b,f,c,g,n){var k=this,y=b._id;k.elongateEvents(k.eventsByID[y],
f,c);k.trigger("eventResize",a,b,f,c,function(){k.elongateEvents(k.eventsByID[y],-f,-c);k.rerenderEvents()},g,n);k.eventsChanged=true;k.rerenderEvents(y)},moveEvents:function(a,b,f,c){f=f||0;for(var g,n=a.length,k=0;k<n;k++){g=a[k];if(c!==K)g.allDay=c;ba(C(g.start,b,true),f);if(g.end)g.end=ba(C(g.end,b,true),f);Ia(g,this.options)}},elongateEvents:function(a,b,f){f=f||0;for(var c,g=a.length,n=0;n<g;n++){c=a[n];c.end=ba(C(this.eventEnd(c),b,true),f);Ia(c,this.options)}},renderOverlay:function(a,b){var f=
this.unusedOverlays.shift();f||(f=o("<div class='fc-cell-overlay' style='position:absolute;z-index:3'/>"));f[0].parentNode!=b[0]&&f.appendTo(b);this.usedOverlays.push(f.css(a).show());return f},clearOverlays:function(){for(var a;a=this.usedOverlays.shift();)this.unusedOverlays.push(a.hide().unbind())},resizableDayEvent:function(a,b,f){var c=this;if(!c.options.disableResizing&&b.resizable)b.resizable({handles:c.options.isRTL?{w:"div.ui-resizable-w"}:{e:"div.ui-resizable-e"},grid:f,minWidth:f/2,containment:c.element.parent().parent(),
start:function(g,n){b.css("z-index",9);c.hideEvents(a,b);c.trigger("eventResizeStart",this,a,g,n)},stop:function(g,n){c.trigger("eventResizeStop",this,a,g,n);var k=Math.round((b.width()-n.originalSize.width)/f);if(k)c.eventResize(this,a,k,0,g,n);else{b.css("z-index",8);c.showEvents(a,b)}}})},eventElementHandlers:function(a,b){var f=this;b.click(function(c){if(!b.hasClass("ui-draggable-dragging")&&!b.hasClass("ui-resizable-resizing"))return f.trigger("eventClick",this,a,c)}).hover(function(c){f.trigger("eventMouseover",
this,a,c)},function(c){f.trigger("eventMouseout",this,a,c)})},option:function(a,b){a=this.options[a];if(typeof a=="object")return hb(a,b||this.name);return a},sliceSegs:function(a,b,f,c){var g=[],n,k=a.length,y,w,t,H,M;for(n=0;n<k;n++){y=a[n];w=y.start;t=b[n];if(t>f&&w<c){if(w<f){w=q(f);H=false}else{w=w;H=true}if(t>c){t=q(c);M=false}else{t=t;M=true}g.push({event:y,start:w,end:t,isStart:H,isEnd:M,msLength:t-w})}}return g.sort(Ib)}},Bb=864E5,Jb=36E5,Hb=6E4;ya.addDays=C;ya.cloneDate=q;var ib=ya.parseDate=
...
1)}if(a[5]){f.setDate(a[5]);c.setDate(a[5])}fb(f,c);a[7]&&f.setHours(a[7]);a[8]&&f.setMinutes(a[8]);a[10]&&f.setSeconds(a[10]);a[12]&&f.setMilliseconds(Number("0."+a[12])*1E3);fb(f,c);if(!b){if(a[14]){g=Number(a[16])*60+Number(a[17]);g*=a[15]=="-"?1:-1}g-=f.getTimezoneOffset()}return new Date(+f+g*60*1E3)},wb=ya.parseTime=function(a){if(typeof a=="number")return a*60;if(typeof a=="object")return a.getHours()*60+a.getMinutes();if(a=a.match(/(\d+)(?::(\d+))?\s*(\w+)?/)){var b=parseInt(a[1]);if(a[3]){b%=
12;if(a[3].toLowerCase().charAt(0)=="p")b+=12}return b*60+(a[2]?parseInt(a[2]):0)}},oa=ya.formatDate=function(a,b,f){return Ha(a,null,b,f)},Ha=ya.formatDates=function(a,b,f,c){c=c||Va;var g=a,n=b,k,y=f.length,w,t,H,M="";for(k=0;k<y;k++){w=f.charAt(k);if(w=="'")for(t=k+1;t<y;t++){if(f.charAt(t)=="'"){if(g){M+=t==k+1?"'":f.substring(k+1,t);k=t}break}}else if(w=="(")for(t=k+1;t<y;t++){if(f.charAt(t)==")"){k=oa(g,f.substring(k+1,t),c);if(parseInt(k.replace(/\D/,"")))M+=k;k=t;break}}else if(w=="[")for(t=
k+1;t<y;t++){if(f.charAt(t)=="]"){w=f.substring(k+1,t);k=oa(g,w,c);if(k!=oa(n,w,c))M+=k;k=t;break}}else if(w=="{"){g=b;n=a}else if(w=="}"){g=a;n=b}else{for(t=y;t>k;t--)if(H=Ob[f.substring(k,t)]){if(g)M+=H(g,c);k=t-1;break}if(t==k)if(g)M+=w}}return M},Ob={s:function(a){return a.getSeconds()},ss:function(a){return Na(a.getSeconds())},m:function(a){return a.getMinutes()},mm:function(a){return Na(a.getMinutes())},h:function(a){return a.getHours()%12||12},hh:function(a){return Na(a.getHours()%12||12)},
H:function(a){return a.getHours()},HH:function(a){return Na(a.getHours())},d:function(a){return a.getDate()},dd:function(a){return Na(a.getDate())},ddd:function(a,b){return b.dayNamesShort[a.getDay()]},dddd:function(a,b){return b.dayNames[a.getDay()]},M:function(a){return a.getMonth()+1},MM:function(a){return Na(a.getMonth()+1)},MMM:function(a,b){return b.monthNamesShort[a.getMonth()]},MMMM:function(a,b){return b.monthNames[a.getMonth()]},yy:function(a){return(a.getFullYear()+"").substring(2)},yyyy:function(a){return a.getFullYear()},
