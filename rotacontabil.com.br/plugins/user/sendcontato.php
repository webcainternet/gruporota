<?php
	...
	ini_set("sendmail_from","gerencia@rotacontabil.com.br");
	...
	$to = 'gerencia@rotacontabil.com.br';
	//$to = 'fernando.mendes@webca.com.br';
	$subject = 'Contato através do site - Rota Contabil';

	// message
	$message = "
	<html>
	<body bgcolor='#F8F8F8'>
	  <p>Contato atraves do site - Rota Contabil</p>
	  <table>
		<tr>
