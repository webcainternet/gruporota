...
<table class="pollstableborder"><?php JPlugin::loadLanguage( 'tpl_beez' ); ?>
	<tr>
		<th id="itema" class="td_1 wrapper-sub-title"><?php echo JText::_( 'Hits' ); ?></th>
		<th id="itemb" class="td_2 wrapper-sub-title"><?php echo JText::_( 'Percent' ); ?></th>
		<th id="itemc" class="td_3 wrapper-sub-title"><?php echo JText::_( 'Graph' ); ?></th>
	</tr>
    <tr><td><br  /></td></tr>
